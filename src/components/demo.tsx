...
export default function Demo({
  ...
  return (
    ...
    <div className="pt-8 pb-10 px-4 sm:px-0 flex justify-center w-full">
      {/* ✅ Responsive width wrapper */}
      <div className="bg-muted/40 rounded-lg p-2 w-full max-w-[90%] sm:max-w-2xl mx-auto">
        ...
        <div
          className={`relative w-full mx-auto rounded-lg overflow-hidden ${className}`}
        >
          <div className="relative w-full aspect-video bg-black rounded-lg overflow-hidden">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-black bg-opacity-60">
              ...
              <p className="text-gray-300 text-sm">Check out our video</p>
            </div>
